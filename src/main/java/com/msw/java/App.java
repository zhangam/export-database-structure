...
public class App {
    ...
    private static RowRenderData getHeader() {
        RowRenderData header = RowRenderData.build(
                ...
                new TextRenderData("字段", POITLStyle.getHeaderStyle()),
                new TextRenderData("描述", POITLStyle.getHeaderStyle()),
                new TextRenderData("类型", POITLStyle.getHeaderStyle()),
                new TextRenderData("长度", POITLStyle.getHeaderStyle()),
                new TextRenderData("必填", POITLStyle.getHeaderStyle()),
        ...
        try {
            ...
            while (set.next()) {
                ...
                RowRenderData row = RowRenderData.build(
                        ...
                        new TextRenderData(getRequired(set.getString("is_nullable")) + ""),
     ...
     * @return
     */
    private static String getRequired(String isNullable) {
